    ...
    for line in content:
        ...
        if matchObj:
            if matchObj.group(1) != version:
                returnval = ctypes.windll.user32.MessageBoxA(0, "A new version of the software is available. Use 'pip install CGAcc' command to get the latest version.",
                 "Software Update", 0x40 | 0x0)
